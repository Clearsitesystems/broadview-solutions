    ...
    async function resolvePost() {
      ...
      if (realArticle && realArticle.status === 'published') {
        ...
        const unified: UnifiedPost = {
          ...
          date: pubDate,
          readTime,
          image: realArticle.featured_image || '/readdy-assets/search-fallback002.jpg',
        ...
        const otherReals = publishedArticles
          ...
          .map((a) => {
            ...
            return {
              ...
              image: a.featured_image || '/readdy-assets/search-fallback003.jpg',
              content: a.content,
        ...
        const realRelated = publishedArticles
          ...
          .map((a) => {
            ...
            return {
              ...
              date: d,
              readTime: `${Math.max(3, Math.ceil(a.content.split(' ').length / 200))} min read`,
              image: a.featured_image || '/readdy-assets/search-fallback004.jpg',
              content: a.content,
              isoDate: a.published_at ? a.published_at.split('T')[0] : a.created_at.split('T')[0],
              isReal: true,
            } as UnifiedPost;
  ...
  const blogPostSchema = [
    {
      ...
      "publisher": {
        ...
        "logo": {
          "@type": "ImageObject",
          "url": `${import.meta.env.VITE_SITE_URL || 'https://example.com'}/favicon.svg`
        }
      },
      "url": `${import.meta.env.VITE_SITE_URL || 'https://example.com'}/blog/${post.id}`,
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": `${import.meta.env.VITE_SITE_URL || 'https://example.com'}/blog/${post.id}`
      },
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 3,
          "name": post.title,
          "item": `${import.meta.env.VITE_SITE_URL || 'https://example.com'}/blog/${post.id}`
        }
      ]
    }
  ];
