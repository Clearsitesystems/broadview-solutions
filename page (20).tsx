  ...
  },
  {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 2,
        "name": "Contact",
        "item": `${import.meta.env.VITE_SITE_URL || 'https://example.com'}/contact`
      }
    ]
  },
  {
  ...
  return (
    <div className="min-h-screen bg-[#1C2B2B]">
      ...
      <section className="relative h-96 flex items-center">
        <img 
          src="/readdy-assets/search-contacthero001.jpg" 
          alt="Contact Us" 
            ...
            <div className="lg:col-span-2">
              <div className="bg-[#1A2424] border border-[#8A9BA8]/20 rounded-2xl p-8 lg:p-12">
                ...
                <form onSubmit={handleSubmit} className="space-y-6" data-readdy-form id="contact-form" ref={formRef} onFocus={handleFormInteraction}>
                  ...
                  <input type="hidden" name="subject" value="New Contact Form Submission - Broadview Solutions" />
