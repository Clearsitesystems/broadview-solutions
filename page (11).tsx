...
const aboutSchema = [
  ...
  },
  {
    ...
    "url": siteUrl,
    "logo": "/readdy-assets/2887571b48c57ebbe859c1035b163ed5.png",
    "image": "/readdy-assets/ff3f335b62270b3bdcbced9e413ec8b4.webp",
    ...
    <>
      ...
      <div className="min-h-screen bg-[#1A2424]">
        ...
        <section className="relative min-h-[70vh] flex items-center pt-24 pb-16 overflow-hidden">
          <img
            src="/readdy-assets/search-about_hero_001.jpg"
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            >
              ...
              <div className="relative">
                ...
                >
                  <img
                    src="/readdy-assets/ff3f335b62270b3bdcbced9e413ec8b4.webp"
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
              ...
              <div className="relative h-80 rounded-xl overflow-hidden">
                <img
                  src="/readdy-assets/search-about_service_area_001.jpg"
