...
const blogSchema = [
  {
    ...
    "url": `${import.meta.env.VITE_SITE_URL || 'https://broad-viewsolutions.com'}/blog`,
    "publisher": {
      "@type": "LocalBusiness",
...
export default function Blog() {
  ...
  const allPosts: DisplayPost[] = useMemo(() => {
    const realPosts: DisplayPost[] = publishedArticles.map((a) => ({
      ...
      image: a.featured_image || 'https://readdy.ai/api/search-image?query=professional%20landscaping%20lawn%20care%20green%20grass%20garden%20maintenance%20outdoor%20yard%20work%20beautiful%20residential%20property&width=800&height=500&seq=fallback001&orientation=landscape',
      content: a.content,
    }));
            ...
            <div className="lg:w-1/3">
              <div className="sticky top-24 space-y-8">
                ...
                <div className="bg-[#2D5016] text-white p-8 rounded-xl border-2 border-[#8A9BA8]/30">
                  ...
                  <form 
                    action="https://readdy.ai/api/form/d6ish1utn3rcgj1rb8rg"
                    method="POST"
                    className="space-y-3" 
                    data-readdy-form 
                    id="newsletter-form"
