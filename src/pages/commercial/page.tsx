...
const commercialSchema = [
  {
    ...
    "url": `${import.meta.env.VITE_SITE_URL || 'https://broad-viewsolutions.com'}/commercial`
  },
  {
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
    "itemListElement": [
      ...
      },
      {
        ...
        "item": `${import.meta.env.VITE_SITE_URL || 'https://broad-viewsolutions.com'}/commercial`
      }
    ]
  }
];
...
export default function Commercial() {
  ...
  const services = {
    'lawn-maintenance': {
      ...
      image: 'https://readdy.ai/api/search-image?query=professional%20landscaper%20operating%20commercial%20zero%20turn%20mower%20on%20large%20industrial%20property%20grounds%20wide%20open%20grass%20area%20warehouse%20or%20manufacturing%20facility%20in%20background%20worker%20in%20safety%20vest%20uniform%20mowing%20expansive%20turf%20industrial%20campus%20grounds%20maintenance%20daytime%20clear%20sky&width=800&height=500&seq=gm_zt_industrial_001&orientation=landscape',
    ...
    'seasonal-cleanup': {
      ...
      image: 'https://readdy.ai/api/search-image?query=seasonal%20landscape%20cleanup%20service%20fall%20leaves%20removal%20spring%20cleanup%20commercial%20property%20maintenance%20seasonal%20transition%20landscaping%20professional%20grounds%20care%20leaf%20collection%20seasonal%20preparation&width=800&height=500&seq=ss001&orientation=landscape',
    ...
    'snow-plowing': {
      title: 'Snow Plowing',
      image: 'https://readdy.ai/api/search-image?query=commercial%20snow%20removal%20service%20plowing%20business%20parking%20lot%20winter%20maintenance%20snow%20plow%20truck%20ice%20management%20commercial%20property%20winter%20services%20professional%20snow%20clearing%20safe%20access&width=800&height=500&seq=sim001&orientation=landscape',
  ...
  return (
    <div className="min-h-screen bg-[#1C2B2B]">
      ...
      <section className="relative h-screen flex items-center">
        <img
          src="https://readdy.ai/api/search-image?query=professional%20commercial%20landscaping%20grounds%20maintenance%20business%20campus%20manicured%20lawn%20corporate%20property%20exterior%20daytime%20clear%20sky%20wide%20angle&width=1920&height=1080&seq=comhero001&orientation=landscape"
